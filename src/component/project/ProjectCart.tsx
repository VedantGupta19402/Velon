  ...
  return (
    <>
      ...
      >
        ...
        <div className='absolute transition-all duration-300 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center top-0 left-0 text-white bg-black/60 backdrop-blur-sm h-full w-full p-6 text-center'>
          {project1 && (
            <span className='text-xs font-mono uppercase tracking-widest text-[#D3FD50] mb-2'>
              {project1.categoryTag || project1.category}
            </span>
          )}
          <h2 className='font-[font1] text-4xl sm:text-6xl border-4 border-white group-hover:border-[#D3FD50] group-hover:text-[#D3FD50] rounded-full pt-2 px-6 transition-all duration-300'>
            View Project
          </h2>
          {project1 && (
            <span className='font-[font2] text-sm sm:text-lg uppercase tracking-wider text-white/70 mt-3'>
              {project1.title}
            </span>
          )}
        </div>
